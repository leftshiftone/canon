...
abstract class AbstractVisitor<R>(private val context: KMap) : IVisitor<List<R>> {
    ...
    open fun visitRating(renderable: Rating) = listOf<R>()
    ...
    open fun visitSelectable(renderable: Selectable) = listOf<R>()
    open fun visitSelection(renderable: Selection) = listOf<R>()
    open fun visitSelectionItem(renderable: SelectionItem) = listOf<R>()
